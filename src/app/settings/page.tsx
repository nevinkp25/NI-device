    ...
    <div className="flex flex-col min-h-screen bg-slate-50/80">
      ...
      <main className="flex-grow p-6 space-y-8 animate-in fade-in duration-500 pb-32">
          ...
          <Card className="rounded-[1.5rem] border-none shadow-sm bg-white overflow-hidden">
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] font-bold text-slate-400 mt-1">Version 15.0</p>
                        </div>
                    </div>
            ...
            <div className="bg-slate-50 p-4 text-center border-t border-slate-100">
                <div className="flex items-center justify-center gap-1.5 opacity-40">
                    ...
                    <p className="text-[9px] font-black tracking-widest text-slate-900">Secure Enterprise Build #15</p>
                </div>
            </div>
          </Card>
        </section>
        ...
        <section className="pt-4">
            <Button 
                variant="outline" 
                className="w-full h-16 border-2 border-red-100 text-red-600 rounded-2xl font-black uppercase text-xs hover:bg-red-50 flex items-center justify-center gap-3 transition-all active:scale-95" 
