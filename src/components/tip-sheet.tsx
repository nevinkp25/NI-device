...
// This useEffect needs to run once to patch the component
const useSheetCloseButtonPatch = () => {
    React.useEffect(() => {
...
const OriginalSheetContent = React.forwardRef<
  React.ElementRef<typeof SheetPrimitive.Content>,
  React.ComponentPropsWithoutRef<typeof SheetPrimitive.Content> & { hideCloseButton?: boolean }
>(({ hideCloseButton, ...props }, ref) => {
  return <SheetPrimitive.Content ref={ref} {...props} />;
});
OriginalSheetContent.displayName = SheetPrimitive.Content.displayName;

const PatchedSheetContent = (props: any) => {
    useSheetCloseButtonPatch();
    return <OriginalSheetContent {...props} />;
}
SheetPrimitive.Content = PatchedSheetContent as any;
